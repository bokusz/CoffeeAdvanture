        ...
        <div class="order-form-wrap">
            ...
            <form method="POST" action="sendOrder.php?key=<?= $keyEnc ?>">
                ...
                <div class="order-block">
                    ...
                    <?php endif; ?>
                    <p class="field-hint">Formátum: <?= htmlspecialchars($defaultWhen) ?>
                        <br><br>Szállítás csak 2026.08.04 - 08.07 közötti napokra és 13:00 - 18:00 közötti időpontokra kérhető.</p>
                    <div class="order-row">
                ...
                <div class="order-block">
                    <h4>Támogatás</h4>
                    <p class="hint">Kávézónk bizalomra épülő rendszerben működik. Nálunk 
                        annyit fizethetsz, amennyit szerinted megérnek
